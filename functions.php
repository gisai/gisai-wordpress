...
function add_myjavascript(){
  wp_enqueue_script( 'ajax-implementation.js', get_stylesheet_directory() . '/scripts/ajax-implementation.js', array( 'jquery' ) );
  wp_enqueue_script( 'bibtex-implementation.js', get_stylesheet_directory() . '/scripts/bibtex-implementation.js', array( 'jquery' ) );
  wp_enqueue_script( 'filter-implementation.js', get_stylesheet_directory() . '/scripts/filter-implementation.js', array( 'jquery' ) );
