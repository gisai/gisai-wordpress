...
function add_myjavascript(){
  wp_register_script( 'ajax-implementation.js', get_stylesheet_directory_uri() . '/scripts/ajax-implementation.js', array( 'jquery' ), null, true );
  wp_enqueue_script('ajax-implementation.js');
  wp_register_script( 'bibtex-implementation.js', get_stylesheet_directory_uri() . '/scripts/bibtex-implementation.js', array( 'jquery' ), null, true );
  wp_enqueue_script('bibtex-implementation.js');
  wp_register_script( 'filter-implementation.js', get_stylesheet_directory_uri() . '/scripts/filter-implementation.js', array( 'jquery' ), null, true );
  wp_enqueue_script('filter-implementation.js');
