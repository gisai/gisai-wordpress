...
function sydney_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'slider_image_2',
        array(
            'default' => get_stylesheet_directory_uri() . '/images/2.jpg',
            'sanitize_callback' => 'esc_url_raw',
        )
    );
    $wp_customize->add_control(
    ...
    $wp_customize->add_control( 'slide_title_size', array(
        'type'        => 'number',
        'priority'    => 25,
        'section'     => 'sydney_fonts',
        'label'       => __('Slide title size', 'sydney'),
        'input_attrs' => array(
            'min'   => 10,
            'max'   => 90,
            'step'  => 1,
    ...
    $wp_customize->add_control( 'slide_subtitle_size', array(
        'type'        => 'number',
        'priority'    => 26,
        'section'     => 'sydney_fonts',
        'label'       => __('Slide subtitle size', 'sydney'),
        'input_attrs' => array(
            'min'   => 10,
            'max'   => 90,
            'step'  => 1,
    ...
    $wp_customize->add_control(
        ...
        array(
            'type'      => 'checkbox',
            'label'     => __('Hide the footer credits bar?', 'sydney'),
            'section'   => 'sydney_footer_credits',
            'priority'  => 12,
        )
    );
    ...
    //___Footer contact___//
    $wp_customize->add_section(
        'sydney_footer_contact',
        array(
            'title'         => __('Footer contact', 'sydney'),
            'priority'      => 11,
            'description'   => __( 'Please note: the contact area will show up only if you add a contact form shortcode', 'sydney' ),
            'panel'         => 'sydney_pro_panel',
        )
    );
    ...
    $wp_customize->add_control(
        'contact_details_title',
        array(
            'label' => __( 'Contact details title', 'sydney' ),
            'section' => 'sydney_footer_contact',
            'type' => 'text',
            'priority' => 10
        )
    );     
    ...
    $wp_customize->add_control(
        'contact_details',
        array(
            'label' => __( 'Contact details', 'sydney' ),
            'description' => __('Add your contact details here [HTML allowed]. Example <a href="https://pastebin.com/h83er5j4" target="_blank">here</a>', 'sydney'),
            'section' => 'sydney_footer_contact',
            'type' => 'textarea',
            'priority' => 11
        )
    ...
    $wp_customize->add_control(
        'contact_form_shortcode',
        array(
            'label'         => __( 'Contact form shortcode', 'sydney' ),
            'description'   => __( 'Use a contact form plugin and add your shortcode here. Example: the Contact Form 7 plugin', 'sydney'),            
            'section'       => 'sydney_footer_contact',
            'type'          => 'text',
            'priority'      => 12
        )
    ...
    $wp_customize->add_control(
        ...
        array(
            'type'      => 'checkbox',
            'label'     => __('Show the contact area only on the homepage?', 'sydney'),
            'section'   => 'sydney_footer_contact',
            'priority'  => 21,
        )
    );  
