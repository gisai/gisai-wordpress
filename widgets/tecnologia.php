...
class Custom_Tecnologia extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sydney_services_widget', 'description' => __( 'Muestra las tecnologías del grupo.', 'sydney'), 'panels_groups' => array('GISAI'), 'panels_icon' => 'dashicons dashicons-hammer' );
				parent::__construct(false, $name = __('Página Principal: Tecnologías', 'sydney'), $widget_ops);
		$this->alt_option_name = 'custom_tecnologia';
