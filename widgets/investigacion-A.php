...
class Custom_Investigacion_A extends WP_Widget {
	...
	public function __construct() {
        ...
        parent::__construct(false, $name = __('Página Principal: Investigación (modelo A)', 'sydney'), $widget_ops);
...
?>
			<?php if ( $title ) echo $before_title . $title . $after_title; ?>
				...
				<div class="services-a-section <?php echo $style; ?>">
