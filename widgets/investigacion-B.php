...
class Custom_Investigacion_B extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sydney_services_widget', 'description' => __( 'Muestra las líneas de investigación del grupo.', 'sydney'), 'panels_groups' => array('GISAI'), 'panels_icon' => 'dashicons dashicons-lightbulb' );
				parent::__construct(false, $name = __('Página Principal: Investigación (modelo B)', 'sydney'), $widget_ops);
		$this->alt_option_name = 'custom_investigacion';
	...
	function form($instance) {
		...
		$bordered			= isset( $instance['bordered'] ) ? (bool) $instance['bordered'] : false;
	...
	<label for="<?php echo $this->get_field_id( 'bordered' ); ?>"><?php _e( 'Remove the border from the icons?', 'sydney' ); ?></label></p>
	...
	function update($new_instance, $old_instance) {
		...
		$instance['bordered'] 		= isset( $new_instance['bordered'] ) ? (bool) $new_instance['bordered'] : false;
	...
	function widget($args, $instance) {
		...
		$bordered			= isset( $instance['bordered'] ) ? $instance['bordered'] : false;
		if ( $bordered ) {
			$border = "noborder";
		} else {
			$border = "hasborder";
...
?>
			<?php if ( $title ) echo $before_title . $title . $after_title; ?>
				...
				<div class="roll-icon-list <?php echo $border; ?>">
