...
class Custom_Miembros_A extends WP_Widget {
	...
	public function __construct() {
        ...
        parent::__construct(false, $name = __('Página Principal: Miembros (modelo A)', 'sydney'), $widget_ops);
		$this->alt_option_name = 'custom_miembros_a';
	...
	<label for="<?php echo $this->get_field_id( 'autoplay' ); ?>"><?php _e( 'Toggle carousel autoplay?', 'sydney' ); ?></label></p>
...
?>
		...
		<div class="roll-team carousel owl-carousel" data-widgetid="employees-<?php echo $args['widget_id']; ?>" data-autoplay="<?php echo $autoplay; ?>">
