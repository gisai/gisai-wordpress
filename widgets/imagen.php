...
class Custom_Imagen extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sydney_image_widget_widget', 'description' => __( 'Muestra una imagen de la librería de medios.', 'sydney'), 'panels_groups' => array('GISAI'), 'panels_icon' => 'dashicons dashicons-format-image' );
        parent::__construct(false, $name = __('Imagen', 'sydney'), $widget_ops);
		$this->alt_option_name = 'custom_imagen';
