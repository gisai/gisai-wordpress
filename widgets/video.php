...
class Custom_Video extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'sydney_video_widget_widget', 'description' => __( 'Muestra un video de youtube, etc...', 'sydney'), 'panels_groups' => array('GISAI'), 'panels_icon' => 'dashicons dashicons-format-video' );
        parent::__construct(false, $name = __('Video', 'sydney'), $widget_ops);
		$this->alt_option_name = 'custom_video';
    }
