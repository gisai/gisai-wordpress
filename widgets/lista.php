...
class Custom_Lista extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'widget_list', 'description' => __('Muestra una lista.', 'sydney'), 'panels_groups' => array('GISAI'), 'panels_icon' => 'dashicons dashicons-list-view' );
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('list', __('Página Principal: Lista','sydney'), $widget_ops, $control_ops);
	}
